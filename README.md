...
Functionality: **_Uses camel-ftp to write a file from source_**
...
git clone https://github.com/jammazwan/xar_FileToFtp.git
cd jammazwan.shared
mvn install 
```
...
_run XarTest, see NOTES.md for prior server setup_
...
so you can focus only on what is required to demo the **FileToFtp** feature **_in isolation_**.
...
The prefix **xar** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
